...
| Step 8 | "`reputation_summary` table refreshed" | Internal table name; kept field names as they describe the public protocol |
...
| Throughout | All "Reference" columns with file:line citations | File:line references |
