...
| Resolution | "`disputeService.resolveDispute()` updates DB + notifications, but does NOT release escrow funds" | Known gap disclosure |
...
| Governance table | "Source" column with file:line refs | File:line references; column dropped entirely |
| Entire section | "Key database tables" with column-level schema | Internal column names; replaced with abstract paragraph |
...
| Failure modes | "Where" column with file:line refs | File:line references; column dropped entirely |
